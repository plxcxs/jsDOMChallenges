...
// 2. When clicking the "previous" button, this event listener
//  is not executed. Do you know what's wrong with this code?
...
// 3. This event listener is connected properly. When clicked,
// the button is shown active. However, the debug message doesn't
// appear in the debug console. Where is the error with this code?
...
// 4. When clicking on the second choice, the button should be
// shown with an active state. Do you see why it isn't working?
